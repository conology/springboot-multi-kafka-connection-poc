...
public class KafkaMessageRelayService {
    ...
    @KafkaListener(topics = "topic1", groupId = "relay-group1", containerFactory = "consumer1ContainerFactory")
    ...
    @KafkaListener(topics = "topic2", groupId = "relay-group2", containerFactory = "consumer2ContainerFactory")
